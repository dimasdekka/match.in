  ...
  return (
    <section className="info-section" aria-label="Matchin resources">
          ...
          >
            ...
            >
              ...
              <div className="info-modal__content">
                ...
                <Image className="info-modal__brand" src="/matchin-logo-white-transparent.png" alt="matchin" width={1086} height={362} />
              </div>
            </motion.div>
          </motion.div>
        )}
      ...
      <div className="footer-watermark" aria-hidden="true">
        <Image src="/matchin-brand.png" alt="" width={1086} height={362} />
      </div>
    </section>
  );
}
